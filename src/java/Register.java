...
public class Register extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       if(a1.isBlank() && a2.isBlank() && a3.isBlank() && a4.isBlank() && a5.isBlank() && a6.isBlank()){
            ...
            out.println("</script>");
            RequestDispatcher requestDispatcher = (RequestDispatcher) request.getRequestDispatcher("Registration.html");
           ...
           try{
                ...
                RequestDispatcher requestDispatcher = (RequestDispatcher) request.getRequestDispatcher("Payment.html");
