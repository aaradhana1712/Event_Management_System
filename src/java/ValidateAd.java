    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter printWriterOut = response.getWriter()) {
            ...
            if(userName.equals(adminUserOne) && userPassword.equals(adminUserOnePassword)){
                RequestDispatcher requestDispatcher = (RequestDispatcher) request.getRequestDispatcher("AdminEvent.html");
                ...
                RequestDispatcher requestDispatcher = (RequestDispatcher) request.getRequestDispatcher("Alogin.html");
